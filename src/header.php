        ...
        <div class="flex items-center justify-between h-16 md:h-20">
          ...
          <div class="site-branding flex items-center space-x-3">
            <?php if (has_custom_logo()): ?>
              <div class="custom-logo w-10 h-10 md:w-12 md:h-12">
                <?php the_custom_logo(); ?>
              </div>
            <?php endif; ?>
            ...
            <?php if (is_front_page() && is_home()): ?>
              <h1 class="site-title m-0">
                <a href="<?php echo esc_url(home_url('/')); ?>" rel="home"
                  class="text-xl md:text-2xl font-bold text-gray-800 hover:text-blue-700 transition-colors duration-200 no-underline">
                  <?php bloginfo('name'); ?>
                </a>
              </h1>
            <?php else: ?>
            ...
            <?php
            $theme_cea_prof_description = get_bloginfo('description', 'display');
            if ($theme_cea_prof_description || is_customize_preview()): ?>
              <p class="site-description hidden lg:block text-sm text-gray-600 m-0 ml-2">
                <?php echo $theme_cea_prof_description; ?>
              </p>
            <?php endif; ?>
          </div>
          ...
          <!-- Mobile Menu Button -->
          <button
            class="menu-toggle md:hidden flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-100 transition-colors duration-200"
