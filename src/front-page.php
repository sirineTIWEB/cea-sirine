    ...
    <?php while (have_posts()) : ?>
        ...
        <section class="hero-section">
            ...
            ?>
                ...
                <div style="background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('<?php echo esc_url($thumbnail_url); ?>'); background-size: cover; background-position: center;"></div>
            <?php else : ?>
                                    ...
                                    <div class="activity-date">
                                        ...
                                        <span>
                                            ...
                                            <?php if ($event_start_time) : ?>
                                                à <?php echo date('H:i', strtotime($event_start_time)); ?>
                                            <?php endif; ?>
                                        </span>
                                    </div>
                                <?php endif; ?>
